...
/** Describes a bytecode heap object. */
public interface BytecodeObject {
  /** Factory to create a bytecode heap object. */
  public interface Factory<T extends BytecodeObject> {
    T create(int spaceId, int numOfSlots);
  }
}
